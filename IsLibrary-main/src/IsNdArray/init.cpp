...
namespace is
{
    namespace nbla
    {
        void init_cpu()
        {
            ...
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<uint>, "cpu:int", double, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<uint>, "cpu:int", double, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<uint>, "cpu:int", double, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<uint>, "cpu:int", double, bool)

...
namespace is
{
    namespace nbla
    {
        void init_cpu()
        {
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ACos, ACos<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ACosh, ACosh<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(AddScalar, AddScalar<uint>, "cpu:int", double, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Add2, Add2<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Affine, Affine<uint>, "cpu:int", int)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Arange, Arange<uint>, "cpu:int", float, float, float)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ASin, ASin<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ASinh, ASinh<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ATan, ATan<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ATan2, ATan2<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(ATanh, ATanh<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(BcAdd2, BcAdd2<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Broadcast, Broadcast<uint>, "cpu:int", const vector<int64_t> &)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Ceil, Ceil<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Concatenate, Concatenate<uint>, "cpu:int", int)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Constant, Constant<uint>, "cpu:int", float, const vector<int> &)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Cos, Cos<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Cosh, Cosh<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(CumProd, CumProd<uint>, "cpu:int", int, bool, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(CumSum, CumSum<uint>, "cpu:int", int, bool, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Div2, Div2<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(EqualScalar, EqualScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Equal, Equal<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Exp, Exp<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Flip, Flip<uint>, "cpu:int", const vector<int64_t> &)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Floor, Floor<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(GreaterEqualScalar, GreaterEqualScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(GreaterEqual, GreaterEqual<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(GreaterScalar, GreaterScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Greater, Greater<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(IsInf, IsInf<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(IsNan, IsNan<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LessEqualScalar, LessEqualScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LessEqual, LessEqual<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LessScalar, LessScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Less, Less<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Log, Log<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Log1p, Log1p<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Log2, Log2<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Log10, Log10<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalAndScalar, LogicalAndScalar<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalAnd, LogicalAnd<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalNot, LogicalNot<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalOrScalar, LogicalOrScalar<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalOr, LogicalOr<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalXorScalar, LogicalXorScalar<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(LogicalXor, LogicalXor<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(MatrixDiagPart, MatrixDiagPart<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(MatrixDiag, MatrixDiag<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Max, Max<uint>, "cpu:int", const vector<int64_t> &, bool, bool, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(MaximumScalar, MaximumScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Maximum2, Maximum2<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Mean, Mean<uint>, "cpu:int", const vector<int64_t> &, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Min, Min<uint>, "cpu:int", const vector<int64_t> &, bool, bool, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(MinimumScalar, MinimumScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Minimum2, Minimum2<uint>, "cpu:int")
            ...
            /*mul_scalar*/
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<bool>, "cpu:bool", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<uchar>, "cpu:ubyte", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<char>, "cpu:byte", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<ushort>, "cpu:ushort", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<short>, "cpu:short", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<uint>, "cpu:uint", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<uint>, "cpu:int", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<ulong>, "cpu:ulong", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<long>, "cpu:long", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<ulonglong>, "cpu:ulonglong", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<longlong>, "cpu:longlong", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<float>, "cpu:float", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<double>, "cpu:double", double)
            NBLA_REGISTER_FUNCTION_IMPL(MulScalar, MulScalar<longdouble>, "cpu:longdouble", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Mul2, Mul2<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(NotEqualScalar, NotEqualScalar<uint>, "cpu:int", double)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(NotEqual, NotEqual<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(PowScalar, PowScalar<uint>, "cpu:int", double, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Pow2, Pow2<uint>, "cpu:int")
            ...
            /*r_div_scalar*/
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<bool>, "cpu:bool", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<uchar>, "cpu:ubyte", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<char>, "cpu:byte", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<ushort>, "cpu:ushort", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<short>, "cpu:short", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<uint>, "cpu:uint", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<uint>, "cpu:int", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<ulong>, "cpu:ulong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<long>, "cpu:long", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<ulonglong>, "cpu:ulonglong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<longlong>, "cpu:longlong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<float>, "cpu:float", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<double>, "cpu:double", double)
            NBLA_REGISTER_FUNCTION_IMPL(RDivScalar, RDivScalar<longdouble>, "cpu:longdouble", double)

            /*r_pow_scalar*/
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<bool>, "cpu:bool", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<uchar>, "cpu:ubyte", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<char>, "cpu:byte", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<ushort>, "cpu:ushort", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<short>, "cpu:short", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<uint>, "cpu:uint", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<uint>, "cpu:int", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<ulong>, "cpu:ulong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<long>, "cpu:long", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<ulonglong>, "cpu:ulonglong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<longlong>, "cpu:longlong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<float>, "cpu:float", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<double>, "cpu:double", double)
            NBLA_REGISTER_FUNCTION_IMPL(RPowScalar, RPowScalar<longdouble>, "cpu:longdouble", double)

            /*r_sub_scalar*/
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<bool>, "cpu:bool", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<uchar>, "cpu:ubyte", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<char>, "cpu:byte", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<ushort>, "cpu:ushort", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<short>, "cpu:short", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<uint>, "cpu:uint", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<uint>, "cpu:int", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<ulong>, "cpu:ulong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<long>, "cpu:long", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<ulonglong>, "cpu:ulonglong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<longlong>, "cpu:longlong", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<float>, "cpu:float", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<double>, "cpu:double", double)
            NBLA_REGISTER_FUNCTION_IMPL(RSubScalar, RSubScalar<longdouble>, "cpu:longdouble", double)
            ...
            // NBLA_REGISTER_FUNCTION_IMPL(Rand, Rand<uint>, "cpu:int", float, float, const vector<int64_t> &, int)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Randint, Randint<uint>, "cpu:int", int, int, const vector<int64_t> &, int)
            ...
            // NBLA_REGISTER_FUNCTION_IMPL(Randn, Randn<uint>, "cpu:int", float, float, const vector<int64_t>& ,int)
           ...
           /*round*/
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Round, Round<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sigmoid, Sigmoid<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sign, Sign<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sin, Sin<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sinc, Sinc<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sinh, Sinh<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Slice, Slice<uint>, "cpu:int", const vector<int64_t> &, const vector<int64_t> &, const vector<int64_t> &)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sort, Sort<uint>, "cpu:int", int, bool, bool, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Split, Split<uint>, "cpu:int", int)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sqrt, Sqrt<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Stack, Stack<uint>, "cpu:int", int)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sub2, Sub2<uint>, "cpu:int", bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Sum, Sum<uint>, "cpu:int", const vector<int64_t> &, bool)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Tan, Tan<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Tanh, Tanh<uint>, "cpu:int")
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Transpose, Transpose<uint>, "cpu:int", const vector<int64_t> &)
            ...
            NBLA_REGISTER_FUNCTION_IMPL(Where, Where<uint>, "cpu:int")
